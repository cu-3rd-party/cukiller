...
<b>Правило 0: <i>Не будь мудаком</i></b><br>
<i>Правила не могут предусмотреть все возможные ситуации.</i><br>
...
<br><br>
<b>0.1. Умышленная порча игрового процесса</b><br>
<b>Запрещены</b> действия, совершаемые с целью <i>испортить игру другим участникам</i>, даже если нарушитель не получает прямой выгоды:<br>
• срыв раскрытий;<br>
• провокации;<br>
• целенаправленное создание конфликтов;<br>
• саботаж;<br>
• систематическое мешательство;<br>
• спам или флуд по игре;<br>
• намеренное затягивание подтверждений и т. п.<br>
...
<br>
<b>1.5. Запрещённые зоны и ситуации для раскрытия:</b><br>
• туалеты и душевые;<br>
• жилые комнаты в общежитии <i>без явного приглашения</i>;<br>
• <b>во время сна</b>;<br>
• на занятиях, лекциях и экзаменах;<br>
...
<br><br>
<b>2.1.</b> <b>Запрещено</b> получать игровое преимущество с помощью:<br>
• использования стороннего ПО, скриптов, ботов или автокликеров;<br>
• эксплуатации уязвимостей, багов и недочётов механик или бота;<br>
• подмены личности, выдачи себя за другого, создания фальшивых аккаунтов;<br>
...
<b>Правило 3: Принцип разрешённого</b><br>
<b>Всё, что не запрещено, разрешено</b>, при условии что это не нарушает правила и не противоречит <i>здравому смыслу</i>!


<b>Правило 4: Мониторинг и решения администрации</b><br>
Администрация может запрашивать пояснения, проверять спорные ситуации и применять <b>санкции</b>.

<br><br>
<b>Санкции</b><br>
Администрация может применить следующие меры:<br>
1. Предупреждение или требование (например, об изменении профиля).<br>
2. Снижение рейтинга игрока.<br>
3. Откат действия (например, раскрытия).<br>
4. Запрет участия в конкретной игре.<br>
5. Удаление профиля.<br>
6. Бан.
...
<b>1. Обязательные поля</b><br>
В досье обязательно нужно указать:<br>
• <b><i>настоящее имя</i></b>;<br>
• <b><i>актуальный курс и поток</i></b>.

<br><br>

<b>2. Фото</b><br>
2.1. Фото должно быть <b>только вашим</b>.<br>
2.2. На фото должно быть <i>отчётливо видно лицо</i>.<br>
2.3. Присутствие <i>посторонних людей</i> <u>нежелательно</u>.<br>
2.4. <b>Запрещены</b>: чужие фотографии, мемы вместо лица, а также изображения, <i>вводящие в заблуждение</i>.

<br><br>

<b>3. Раздел «О себе»</b><br>
