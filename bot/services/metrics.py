...
class BotMetrics:
    ...
    def __init__(self):
        ...
        self.games_total = Gauge(
            'cukiller_games_total',
            'Total number of games',
            ['status']
        )
        self.games_created = Counter(
            'cukiller_games_created_total',
    ...
    async def update_user_metrics(self):
        ...
        try:
            ...
            logger.debug(f"Updated user metrics: total={total_users}, confirmed={confirmed_users}, pending={pending_users}")
    ...
    async def update_game_metrics(self):
        ...
        try:
            ...
            logger.debug(f"Updated game metrics: total={total_games}, active={active_games}, completed={completed_games}")
        except Exception as e:
